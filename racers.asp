...
<body>
  <div id="main">
    ...
    <nav>
      <div class="table">
        <div class="row">
          ...
          <div class="cell">
            <a class="mailtable" href="javascript:void(0);">Racers</a>
          </div>
          <div class="cell">
    ...
    <section id="sectionID">
      <form id="formID" method="POST" action="racers.asp">
        <%
      ...
      if (flag == "-1"){
        ...
        Response.write(str + id + "<a href=\"racers.asp\">(exit)</a><input type=\"hidden\" name=\"flag\" value=\"1\">");
      }
      else if (flag == "2"){
        Response.write(str + id + "<a href=\"racers.asp\">(exit)</a><input type=\"hidden\" name=\"flag\" value=\"2\">"); 
      }
    %>
      </form>
    </section>
    <section class="mainsection">
      ...
      if (flag == "1" || flag == "2"){
        try{   
          printTable(conn.Execute("select * from racer"));
        }
        catch(exception){
        ...
        function printTable(results) 
        {
          ...
          Response.write("<table class=\"datatable\"><caption>Racer table</caption><tr>");
        ...
        if (flag == "2"){
          Response.write("<div><form id=\"addform\" action=\"addrow.asp\" method=\"POST\"><table><caption>Add new racer</caption>" + 
          "<tr><th>Racer Name</th><td><input type=\"text\" name=\"RacerName\" value=\"\" required></td></tr>" +
          "<tr><th>Age</th><td><input type=\"text\" name=\"Age\" value=\"\" required></td></tr>" +
          ...
          "</table><input type=\"hidden\" name=\"table\" value=\"racer\"><input class=\"button\" type=\"reset\" value=\"reset\"><input class=\"button\" type=\"submit\" value=\"confirm\"></form></div>" + 
          "<div><h2>Select the line to be deleted or update</h2><select id=\"Select\">");
          try{
            result = conn.Execute("select key from racer");
            while(!result.eof){
          ...
          "<input id=\"del\" type=\"hidden\" name=\"del\" value=\"\"><input type=\"hidden\" name=\"table\" value=\"racer\">" + 
          "<input id=\"delButton\" class=\"button\" type=\"submit\" value=\"delete\"></form>" + 
          "<form  id=\"altrow\" action=\"altrow.asp\" method=\"POST\">" + 
          "<input id=\"alt\" type=\"hidden\" name=\"alt\" value=\"\"><input type=\"hidden\" name=\"table\" value=\"racer\">" + 
