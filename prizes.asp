...
<body>
  <div id="main">
          ...
          <div class="cell">
            <form name="home" method="POST" action="index.asp">
              <%
                print();
              %>
              <a href="javascript: document.home.submit();"><img id="home" src="assets/img/button_home.jpg" alt="home"></a>
            </form>
          </div>
          <div class="cell">
            <form name="racers" method="POST" action="racers.asp">
              ...
              print();
              %>
              <a href="javascript: document.racers.submit();">Racers</a>
            </form>
          </div>
          <div class="cell">
            <form name="teams" method="POST" action="teams.asp">
              ...
              print();
              %>
              <a href="javascript: document.teams.submit();">Teams</a>
            </form>
          </div>
          <div class="cell">
            <form name="races" method="POST" action="races.asp">
              ...
              print();
              %>
              <a href="javascript: document.races.submit();">Races</a>
            </form>
          </div>
          <div class="cell">
            <form name="sponsors" method="POST" action="sponsors.asp">
              ...
              print();
              %>
              <a href="javascript: document.sponsors.submit();">Sponsors</a>
            </form>
          </div>
          <div class="cell">
            <form name="participations" method="POST" action="participations.asp">
              ...
              print();
              %>
              <a href="javascript: document.participations.submit();">Participations</a>
            </form>
          </div>
          <div class="cell">
            <a href="javascript:void(0);">Prizes</a>
          </div>
        </div>
      </div>
    </nav>
    <section id="sectionID">
      <form id="formID" method="POST" action="prizes.asp">
        <%
        ...
        if (flag == "-1"){
          ...
          Response.write(str + id + "<a href=\"prizes.asp\">(exit)</a><input type=\"hidden\" name=\"flag\" value=\"1\">");
        }
        else if (flag == "2"){
          Response.write(str + id + "<a href=\"prizes.asp\">(exit)</a><input type=\"hidden\" name=\"flag\" value=\"2\">"); 
        }
      %>
      </form>
    </section>
    <section class="mainsection">
      ...
      if (flag == "1" || flag == "2"){
        try{  
          printTable(conn.Execute("select * from prize"));
        }
        catch(exception){
        ...
        function printTable(results) 
        {
          ...
          Response.write("<table class=\"datatable\"><caption>Prize table</caption><tr>");
        ...
        if (flag == "2"){
          Response.write("<div><form id=\"addform\" action=\"addrow.asp\" method=\"POST\"><table><caption>Add new prize</caption>" + 
          "<tr><th>Race</th><td class=\"inptext\"><input type=\"text\" name=\"Race\" value=\"\" required></td></tr>" +
          "<tr><th>Racer</th><td class=\"inptext\"><input type=\"text\" name=\"Racer\" value=\"\" required></td></tr>" +
          "<tr><th>Cash</th><td class=\"inptext\"><input type=\"text\" name=\"Cash\" value=\"\" required></td></tr>" +       
          "<tr><th>Place</th><td class=\"inptext\"><input type=\"text\" name=\"Place\" value=\"\" required></td></tr>" + 
          "</table><input type=\"hidden\" name=\"table\" value=\"prize\"><input class=\"button\" type=\"reset\" value=\"reset\"><input class=\"button\" type=\"submit\" value=\"confirm\"></form></div>" + 
          "<div><h2>Select the line to be deleted or update</h2><select id=\"Select\">");
          try{
            result = conn.Execute("select key from prize");
            while(!result.eof){
          ...
          "<input id=\"del\" type=\"hidden\" name=\"del\" value=\"\"><input type=\"hidden\" name=\"table\" value=\"prize\">" + 
          "<input id=\"delButton\" class=\"button\" type=\"submit\" value=\"delete\"></form>" + 
          "<form  id=\"altrow\" action=\"altrow.asp\" method=\"POST\">" + 
          "<input id=\"alt\" type=\"hidden\" name=\"alt\" value=\"\"><input type=\"hidden\" name=\"table\" value=\"prize\">" + 
